...
class CFDIGenerator:
    ...
    def __init__(self, certificado_path=None, key_path=None, key_password=None,
                 signer=None):
        self.certificado_path = certificado_path
        self.key_path = key_path
        self.key_password = key_password
        self._signer = signer  # permite inyectar un Signer ya cargado
        ...
        try:
            ...
            try:
                ...
                if 'comprobante' in locals() and comprobante:
                    ...
                    # Get project root (go up one level from app/facturacion/ to project root)
