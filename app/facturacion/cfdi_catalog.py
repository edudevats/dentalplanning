...
CFDI_USAGE_CATALOG = {
    ...
    'D01': {
        ...
        'category': 'Deducción personal',
        'tax_implication': 'Deducible (persona física)',
        'guide': 'Uso típico del paciente para deducir servicios dentales/médicos.'
    },
    'D02': {
        'description': 'Gastos médicos por incapacidad o discapacidad',
        'category': 'Deducción personal',
        'tax_implication': 'Deducible (persona física)',
        'guide': 'Gastos médicos derivados de incapacidad o discapacidad.'
    },
